...
return [
    ...
    'invitation' => [
        'message_1'         => 'Jūs saņēmāt šo e-pasta ziņojumu, jo esat uzaicināts pievienoties Nuaxa Network.',
    ...
    'information' => [
        ...
        'customize'         => 'Pielāgojiet savu Nuaxa Network',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrators',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu Nuaxa Network, tostarp klientiem, rēķiniem, pārskatiem, iestatījumiem un lietotnēm.',
        ],
        'manager' => [
            'name'          => 'Vadītājs',
            'description'   => 'Viņi iegūst pilnu piekļuvi jūsu Nuaxa Network, taču nevar pārvaldīt lietotājus un lietotnes.',
        ],
        'customer' => [
            'name'          => 'Klients',
