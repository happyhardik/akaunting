...
return [
    ...
    'invitation' => [
        'message_1'         => 'Primili ste ovaj email jer ste pozvani da se pridružite Nuaxa Networku.',
    ...
    'information' => [
        ...
        'customize'         => 'Prilagodite svoj Nuaxa Network',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Oni dobijaju potpuni pristup vašem Nuaxa Network-u uključujući klijente, fakture, izvještaje, postavke i aplikacije.',
        ],
        'manager' => [
            'name'          => 'Upravljaj',
            'description'   => 'Oni imaju potpuni pristup vašem Nuaxa Networku, ali ne mogu upravljati korisnicima i aplikacijama.',
        ],
        'customer' => [
            'name'          => 'Kupci',
