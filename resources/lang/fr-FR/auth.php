...
return [
    ...
    'invitation' => [
        'message_1'         => 'Vous recevez cet e-mail parce que vous êtes invité à rejoindre Nuaxa Network.',
    ...
    'information' => [
        ...
        'customize'         => 'Personnaliser votre Nuaxa Network',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Administrateur',
            'description'   => 'Ils obtiennent un accès complet à votre Nuaxa Network, y compris vos clients, factures, rapports, paramètres et applications.',
        ],
        'manager' => [
            'name'          => 'Gérant',
            'description'   => 'Ils ont un accès complet à votre Nuaxa Network, mais ne peuvent pas gérer les utilisateurs et les applications.',
        ],
        'customer' => [
            'name'          => 'Client',
