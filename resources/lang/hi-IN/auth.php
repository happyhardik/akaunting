...
return [
    ...
    'invitation' => [
        'message_1'         => 'आपको यह ईमेल इसलिए प्राप्त हो रहा है क्योंकि आपको Nuaxa Network में शामिल होने के लिए आमंत्रित किया गया है।',
    ...
    'information' => [
        ...
        'customize'         => 'अपनी Nuaxa Network को अनुकूलित करें',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'व्यवस्थापक',
            'description'   => 'उन्हें ग्राहकों, इनवॉइस, रिपोर्ट, सेटिंग्स और ऐप्स सहित आपकी Nuaxa Network तक पूरी पहुंच मिलती है।',
        ],
        'manager' => [
            'name'          => 'प्रबंधक',
            'description'   => 'उन्हें आपके Nuaxa Network का पूरा एक्सेस मिलता है, लेकिन वे उपयोगकर्ताओं और ऐप्स को प्रबंधित नहीं कर सकते।',
        ],
        'customer' => [
            'name'          => 'ग्राहक',
