...
return [
    ...
    'invitation' => [
        'message_1'         => 'Du modtager denne e-mail, fordi du er inviteret til at deltage i Nuaxa Network.',
    ...
    'information' => [
        ...
        'customize'         => 'Tilpas din Nuaxa Network',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'De får fuld adgang til din Nuaxa Network herunder kunder, fakturaer, rapporter, indstillinger og apps.',
        ],
        'manager' => [
            'name'          => 'Leder',
            'description'   => 'De får fuld adgang til din Nuaxa Network, men kan ikke administrere brugere og apps.',
        ],
        'customer' => [
            'name'          => 'Kunde',
