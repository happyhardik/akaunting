...
return [
    ...
    'invitation' => [
        'message_1'         => 'Sie erhalten diese E-Mail, weil Sie zur zusammenarbeit bei Nuaxa Network eingeladen wurden.',
    ...
    'information' => [
        ...
        'customize'         => 'Passen Sie Ihr Nuaxa Network an',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Admin',
            'description'   => 'Sie erhalten vollen Zugriff auf Nuaxa Network, einschließlich Kunden, Rechnungen, Berichte, Einstellungen und Apps.',
        ],
        'manager' => [
            'name'          => 'Manager',
            'description'   => 'Sie erhalten vollen Zugriff auf Nuaxa Network, können aber keine Benutzer und Apps verwalten.',
        ],
        'customer' => [
            'name'          => 'Kunde',
