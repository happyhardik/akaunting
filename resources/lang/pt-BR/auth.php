...
return [
    ...
    'invitation' => [
        'message_1'         => 'Você está recebendo este e-mail porque foi convidado a juntar-se ao Nuaxa Network.',
    ...
    'information' => [
        ...
        'customize'         => 'Personalize seu Nuaxa Network',
    ],
    ...
    'roles' => [
        ...
        'manager' => [
            'name'          => 'Gerente',
            'description'   => 'Eles têm acesso total ao seu Nuaxa Network, mas não podem gerenciar usuários e apps.',
        ],
        'customer' => [
            'name'          => 'Cliente',
