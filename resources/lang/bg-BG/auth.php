...
return [
    ...
    'invitation' => [
        'message_1'         => 'Получавате този имейл, защото сте поканени да се присъедините към Nuaxa Network.',
    ...
    'information' => [
        ...
        'customize'         => 'Персонализирайте вашия Nuaxa Network',
    ],

    'roles' => [
        'admin' => [
            'name'          => 'Администратор',
            'description'   => 'Те получават пълен достъп до вашия Nuaxa Network, включително клиенти, фактури, отчети, настройки и приложения.',
        ],
        'manager' => [
            'name'          => 'Мениджър',
            'description'   => 'Те получават пълен достъп до вашия Nuaxa Network, но не могат да управляват потребители и приложения.',
        ],
        'customer' => [
            'name'          => 'Клиент',
